...
class Tickets:
    ...
    def __init__(self):
        ...
        self.times_file = Config.TIMES_FILE
    ...
    def get_tickets(self):
        try:
            ...
            for project in self.projects:
                ...
                if project_id != -1:
                    tickets = redmine.issue.filter(project_id=project_id, updated_on="><{}|{}".format(self.start_date, end_date), status_id='*')
                    for ticket in tickets:
                        ...
                        self.logger.log(logging.INFO, "project={}$$tracker={}$$status={}$$priority={}$$author={}$$assigned_to={}$$category={}$$created_on={}$$updated_on={}"
                        .format(project_name, tracker, status, priority, author, assigned_to, category, created_on, updated_on))
                        #print(list(ticket))
    ...
    def get_last_read_time(self):
        try:
            file = self.log_dir + self.times_file
    ...
    def set_last_read_time(self, end_date):
        try:
            with open(self.log_dir + self.times_file, "a+") as f1:
                f1.write(end_date + "\n")
        except Exception as e:
